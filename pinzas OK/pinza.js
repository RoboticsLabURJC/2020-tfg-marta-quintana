...
document.addEventListener('keydown', (event)=>{
  ...
  // Tecla para iniciar físicas y colocación inicial (enter)
    ...
    mbot.body.position.set(0,0.5,-3)
    mbot.rotation=(0,90,0)    // Se ubican las pinzas a la posición incial
    pinza_izquierda.body.position.set(-0.1,0.5,-3.3)
    pinza_derecha.body.position.set(0.1,0.5,-3.3)
    pinza_izquierda.rotation=(0,0,0)
    pinza_derecha.rotation =(0,0,0)
    ...
    if (moveInterval != null){
      ...
      moveInterval = setInterval(function(){
        ...
        // se rotan las pinzas
        pinza_derecha.body.angularVelocity.y=pinza_izquierda.body.angularVelocity.y = -0.5;
