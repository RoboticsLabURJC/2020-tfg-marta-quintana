function run_fisicas() {
    ...
    firstMaterial.mass = 100000;
    secondMaterial.restitution = -1
    secondMaterial.mass = 100000;
    thirdMaterial.restitution = -1
    thirdMaterial.mass = 1;
    ...
    var cm1 = new CANNON.ContactMaterial(firstMaterial,secondMaterial,[restitution = 0]);
    var cm2 = new CANNON.ContactMaterial(firstMaterial,thirdMaterial, [restitution = 0]);
    var cm6 = new CANNON.ContactMaterial(secondMaterial,thirdMaterial, [restitution = 0]);
    var cm7 = new CANNON.ContactMaterial(thirdMaterial, secondMaterial, [restitution = 0]);
    var cm3 = new CANNON.ContactMaterial(secondMaterial,firstMaterial,[restitution = 0]);
    var cm4 = new CANNON.ContactMaterial(thirdMaterial, firstMaterial,[restitution = 0]);
